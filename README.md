...
### Stack
<p align="center">
  <img src="https://skillicons.dev/icons?i=html,css,js,ts,bootstrap,tailwind,react,nextjs,vue,nodejs,express,nestjs,mongodb,mysql,postgres,java,python,cpp,cs,linux,git,docker,aws" />
</p>

---

### Current Focus
- Building 3 profitable, scalable startups by the end of 2026
- Actively participating in hackathons, builder programs & competitive tech challenges
- Implementing DevOps pipelines & infrastructure (Docker, Linux, Nginx, CI/CD)
- Exploring Solana ecosystem, smart contracts & on-chain applications
---
